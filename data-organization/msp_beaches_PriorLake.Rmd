...
filelist <- list.files(path = path, 
                          ...
                          full.names = TRUE) # I don't fully understand what this does, but it necessary to make the lines below work
                          

# priordata = lapply(files, read_xlsx(skip=1)) # reads all data in as one list --> not working
#   
...
for (i in 1:length(files)) {
  ...
  rename_lookup <- c("date" = "sample_date")  
